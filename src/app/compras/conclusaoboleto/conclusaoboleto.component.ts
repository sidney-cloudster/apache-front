...
@Component({
  selector: 'app-conclusaoboleto',
  templateUrl: './conclusaoboleto.component.html',
  styleUrls: ['./conclusaoboleto.component.css']
})
export class ConclusaoboletoComponent implements OnInit {
